...
public final class GeofenceUtils {
    ...
    public static final String KEY_RADIUS = "edu.pitt.relativecare.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "edu.pitt.relativecare.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "edu.pitt.relativecare.KEY_TRANSITION_TYPE";
